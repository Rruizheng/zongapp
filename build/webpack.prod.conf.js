...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      chunksSortMode: 'dependency',
      chunks: ['manifest', 'vendor', 'cername']
    }),
    new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPlugin({
      ...
      chunksSortMode: 'dependency',
      chunks: ['manifest', 'vendor', 'cerland']
    }),
    new HtmlWebpackPlugin({
      ...
      chunksSortMode: 'dependency',
      chunks: ['manifest', 'vendor', 'citySelect']
    }),
